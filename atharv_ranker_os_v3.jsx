...
// ─── IDENTITY ─────────────────────────────────────────────────────────────────
const USER = { name: "Atharv", target: "JEE 2029", role: "Class 11", storagePrefix: "atharv" };
...
// ─── SYLLABUS ────────────────────────────────────────────────────────────────
const CHAPTERS = {
  Mathematics: ["Sets","Basic Mathematics","Quadratic Equations","Sequence and Series","Trigonometric Functions","Trigonometric Equations","Relations and Functions","Permutation and Combination","Binomial Theorem","Straight Line","Circles","Parabola","Ellipse","Hyperbola","Complex Number","Limits and Derivatives","Statistics","Probability","Introduction to 3D Geometry","Linear Inequality","Solution of Triangle"],
  Physics: ["Units and Measurements","Mathematical Tools","Motion in a Straight Line","Motion in a Plane","Laws of Motion + Friction","Circular Motion","Work, Energy and Power","Centre of Mass & System of Particles","Rotational Motion","Gravitation","Mechanical Properties of Solids","Mechanical Properties of Fluids","Thermal Properties of Matter","Kinetic Theory & Thermodynamics","Simple Harmonic Motion","Waves"],
  "Physical Chemistry": ["Some Basic Concepts of Chemistry","Structure of Atom","State of Matter","Thermodynamics","Redox Reaction","Chemical Equilibrium","Ionic Equilibrium"],
  "Inorganic Chemistry": ["Classification of Elements and Periodicity in Properties","Chemical Bonding and Molecular Structure","P-block Elements (Group 13 and 14)","S-block Element","Hydrogen and its Compound"],
  "Organic Chemistry": ["IUPAC Nomenclature","GOC","Isomerism","Hydrocarbon","Purification and Analysis of Organic Compound","Environmental Chemistry"]
};

// ─── STORAGE ─────────────────────────────────────────────────────────────────
const stor = {
  set: async (k, v) => { try { await window.storage.set(k, JSON.stringify(v)); } catch(e) {} },
  get: async (k, fb) => { try { const r = await window.storage.get(k); return r ? JSON.parse(r.value) : fb; } catch(e) { return fb; } }
};
    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: T.bg, minHeight: "100vh", color: T.text }}>
      ...
      <div style={{ background: T.s1, borderBottom: `1px solid ${T.bd}`, padding: "0 20px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 48, position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 9, color: T.mut, background: T.s2, padding: "2px 7px", borderRadius: 4, border: `1px solid ${T.bd}`, letterSpacing: "0.08em" }}>ATHARV · JEE 2029</span>
        </div>
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div style={css.card}>
          ...
          <div style={{ fontSize: 10, color: T.mut, marginTop: 5 }}>Class 11 target: 5–7h/day.</div>
        </div>
        <div style={css.card}>
      ...
      <div style={css.card}>
        ...
        <div style={{ fontSize: 12, color: T.mut, marginBottom: 10, lineHeight: 1.6 }}>Your honest starting point. What you know, what you do not. Where you tend to slip. This becomes the baseline for all feedback.</div>
        <textarea rows={12} style={{ ...css.inp, resize: "vertical", lineHeight: 1.7, borderColor: (form.confession?.length || 0) < 80 ? T.red + "66" : T.bd2 }}
          placeholder="My strong subjects are ___. I find ___ difficult. My study habit problem is ___. I tend to avoid ___ because ___..."
